function CalculateTheDay()
{
    ...
    if (FinalDay == 1)
    {
        document.getElementById('h2').innerHTML = ("That day is on Sunday");
    }
    else if (FinalDay == 2)
    {
        document.getElementById('h2').innerHTML = ("That day is on Monday");
    }
    else if (FinalDay == 3)
    {
        document.getElementById('h2').innerHTML = ("That day is on Tuesday");
    }
    else if (FinalDay == 4)
    {
        document.getElementById('h2').innerHTML = ("That day is on Wednesday");
    }
    else if (FinalDay == 5)
    {
        document.getElementById('h2').innerHTML = ("That day is on Thursday");
    }
    else if (FinalDay == 6)
    {
        document.getElementById('h2').innerHTML = ("That day is on Friday");
    }
    else if (FinalDay == 0)
    {
        document.getElementById('h2').innerHTML = ("That day is on Saturday");
    }
